    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Join us to start buying, selling, and renting properties</p>
        </div>
            ...
            <div className="flex gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-w-[120px]"
                >
                  <span className="text-sm">
                    {COUNTRY_CODES.find(c => c.code === formData.countryCode)?.country || 'IN'} {formData.countryCode}
                  </span>
                      ...
                      {COUNTRY_CODES.map((country, index) => (
                        <button
                          ...
                          className={`w-full px-3 py-2 text-left text-sm hover:bg-gray-50 ${
                            formData.countryCode === country.code ? 'bg-gray-100' : ''
                          } ${index !== COUNTRY_CODES.length - 1 ? 'border-b border-gray-100' : ''}`}
                        >
                          {country.country} {country.code} - {country.name}
                        </button>
                      ))}
                    </div>
                  </>
              ...
              <div className="flex-1">
                <Input
                  ...
                  onChange={(e) => {
                    // Remove all non-digits and limit to 15 characters
